...
# 4. Plot 
plot(regsum$bic, type = "b",
     xlab = "Number of predictors", ylab = "Test MSE")
best_size <- which.min(regsum$bic)
cat("Best subset siz:", best_size, "\n")

# 5. Extract coefficients of the best model
best_coef <- coef(regfit, best_size)
best_coef

# Predict on the test set
pred_sub <- test_mat[, names(best_coef)] %*% best_coef

# test‐set MSE
mse_sub <- mean((test$TargetNum - pred_sub)^2)
cat("Subset test MSE:", mse_sub, "\n")
